...
\begin{abstract}
  ...
  target-language model. Using the MT system, \todo{FSM: Check
    rewording! I have removed existing MT from this and previous
    sentence.} the sentences in the source-language corpus are
