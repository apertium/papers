...
[ \{br\} ur pegsun nevez da dapout e montroulez d'ar 15 a viz kerzu ] [\{fr\} nouvel autocollant dispo à #morlaix le 15 décembre ! ] \\

For our current task, each of the texts have been limited to two languages i.e. the primary and the secondary language. Hence the type of chunking tags are limited to these. 
