...
\section{Results}
\label{sec:results}
As described in ~\ref{sec:method} the data collected from Twitter for the three language pairs, was processed using the techniques mentioned. The statics of the same are described in ~\ref{table:accuracy}. // 
