...
The \texttt{langid.py} based methods allow for segmenting the text into chunks, but favour the majority language.\footnote{This could be because of the default models being used.} 
