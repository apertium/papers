...
of \{`\_ s', `s l', `l \'{a}', `\'{a} i', `i n', `n t', `t e', `e !', `! \_'\}.
		...
		\headerbox{Typology}{name=examples,column=1,row=0,span=2}{
		%	\begin{table}[h]
			\begin{center}
			\begin{tabular}{ll}
		...
		\headerbox{Annotated Data}{name=examplescode,column=1,span=2,below=examples}{
		\begin{center}
		...
		\headerbox{Chunking algorithm}{name=lexc,column=1,below=examplescode,span=2}{
