...
%		\end{figure}
	...
	%	\label{table:datastats}
		...
		\headerbox{Chunking algorithm}{name=lexc,below=morphtrans}{
		\includegraphics[trim = 4.4cm 5cm 0 4cm, clip, scale=0.55]{pseudocode.pdf}
%		\begin{algorithm}
%		\caption*{\textsc{}}
...
%		\end{figure}
		...
		\headerbox{Methodology}{name=exout,column=1,row=0}{
...
of \{`\_ s', `s l', `l \'{a}', `\'{a} i', `i n', `n t', `t e', `e !', `! \_'\}.
		...
		\headerbox{Evaluation}{name=eval,column=2,row=0}{
		...
		\headerbox{Results}{name=results,column=2,below=eval}{
			
		\includegraphics[trim = 4.7cm 15cm 0 4cm, clip, scale=0.55]{results.pdf}
		%	\begin{center}
