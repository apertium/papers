...
%			\end{center}
		...
		\scalebox{0.85}{
			\begin{tabular}{llll}
				...
				\bottomrule
					\multirow{2}{*}{\texttt{\textbf{kaz}}} & \multirow{2}{*}{{\qipa и, у, ю}} & {\qipa /əj, əw, jəw/} & {\qipa қ\hiliteone{ию}д\hilitetwo{а}} \eng{in the process of chopping down} \\
					...
					\multirow{3}{*}{\texttt{\textbf{kum}}} & \multirow{3}{*}{{\qipa ё, ю}} & {\qipa /ø, y/ / C \_} & {\qipa г\hiliteone{ё}зл\hilitetwo{е}р} \eng{eyes}, {\qipa г\hiliteone{ю}нл\hilitetwo{е}р} \eng{days}\\
