...
\definecolor{headercolone}{RGB}{153,0,0}
\definecolor{headercoltwo}{RGB}{153,0,0}
...
%		}
	...
	\headerbox{Kypchak languages}{name=kypchaklgs,column=0,row=0}{
		...
		\begin{tabular}{llll}
			...
			\midrule
				& \multicolumn{3}{l}{population of speakers} \\
			\midrule
				number & 8M-12M & 5.4M & 430K \\
				pronunc & /{\qipa qɑzɑq}/ & /{\qipa tɒtɑɾ}/ & /{\qipa qumuq}/ \\
				primary & Kazakhstan & Tatarstan & Dagestan \\
				secondary & China, Mongolia &  &  \\
			\midrule
				& \multicolumn{3}{l}{external influences} \\
			\midrule
...
%		\end{itemize}
	...
	\headerbox{Morphological transducers}{name=morphtrans,below=kypchaklgs}{
		...
		\begin{itemize}
			...
			\item Kyrgyz (\hiliteone{Tyers et al., 2012})
			\item \hiliteone{GPL (=free and open)}!
		\end{itemize}
...
%		}
		...
		\pex[aboveexskip=0pt,belowexskip=3pt]\label{ex:sent}
			\begingl
				\gla[everygla={\qipa }] Аллагь Оьзю яратгъан затларгъа къарап, олар бек яхшы экенин гёрген. //
				\glb God own-his made thing-s-to look-having, they very good being saw. //
				\glft \vspace{-0.5em}\eng{God looked at everything he had made and saw that it was very good.} //
			\endgl
		\xe
...
\midrule
 \texttt{Құдай\tags{<n><nom>}} & \texttt{Аллаһ\tags{<n><nom>}} & \texttt{Аллагь\tags{<n><nom>}} \\
 \texttt{Өз\tags{<prn><ref><px3sp><gen>}} & \texttt{Үз\tags{<prn><ref><px3sp><nom>}} & \texttt{Оьз\tags{<prn><ref><px3sp><nom>}} \\
 \texttt{жарат\tags{<v><tv><ger\_past><pl><px3sp><gen>}} & \texttt{ярат\tags{<v><tv><gpr\_past>}} & \texttt{ярат\tags{<v><tv><gpr\_past>}} \\
 \texttt{бәрі\tags{<prn><qnt><px3sp><dat>}} & \texttt{нәрсә\tags{<prn><itg><pl><dat>}} & \texttt{зат\tags{<n><pl><dat>}} \\
 \texttt{қара\tags{<v><tv><gna\_perf>}} & \texttt{кара\tags{<v><tv><gna\_perf>}} & \texttt{къара\tags{<v><tv><gna\_perf>}} \\ 
\texttt{,\tags{<cm>}} & \texttt{,\tags{<cm>}} & \texttt{,\tags{<cm>}} \\
 ---      & \texttt{алар\tags{<prn><pers><p3><pl><gen>}} & \texttt{олар\tags{<prn><pers><p3><pl><nom>}} \\
 \texttt{өте\tags{<adv>}} & \texttt{бик\tags{<adv>}} & \texttt{бек\tags{<adv>}} \\
 \texttt{жақсы\tags{<adj>}} & \texttt{яхшы\tags{<adj>}} & \texttt{яхшы\tags{<adj>}} \\
 \texttt{е\tags{<cop><ger\_past><px3sp><acc>}} & \texttt{и\tags{<cop><ger\_past><px3sp><acc>}} & \texttt{э\tags{<cop><ger\_past><px3sp><acc>}} \\
 \texttt{көр\tags{<v><tv><ifi><p3><sg>}} & \texttt{күр\tags{<v><tv><past><p3><sg>}} & \texttt{гёр\tags{<v><tv><past><p3><sg>}} \\  
 \texttt{.\tags{<sent>}} & \texttt{.\tags{<sent>}} & \texttt{.\tags{<sent>}} \\
\bottomrule
\end{tabular}
}
...
%  \texttt{{\small <px3sg>}} \> 3rd person poss. (Singular)\\[-0.5ex]
  \texttt{{\small <px3sp>}} \> 3rd person poss. (Singular/Plural)\\[-0.5ex]
