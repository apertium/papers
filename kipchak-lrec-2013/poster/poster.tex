	...
	\headerbox{Kypchak languages}{name=kypchaklgs,column=0,row=0}{
		...
		\begin{tabular}{llll}
			\toprule
				& Kazakh & Tatar & Kumyk \\
			\midrule
				№ speakers & >8M & 5.4M & 430K \\
				primary pop. & Kazakhstan & Tatarstan & Dagestan \\
				Mongolic infl. & moderate & light & light \\
				Oghuz infl. & — & light & moderate \\
				Persian infl. & heavy & heavy & heavy \\
				Russian infl. & heavy & heavy & heavy \\
			\bottomrule
		\end{tabular}
%			\begin{itemize}
...
%		\end{itemize}
	...
	\headerbox{Morphological transducers}{name=morphtrans,below=kypchaklgs}{
		...
		\begin{itemize}
			\item Take a surface form, and produce all valid lexical forms\\
				e.g. `алдым'
			\item Take a lexical form, and produce one or more valid surface forms\\
				e.g., \texttt{ал{\small <v><tv><ifi><p1><sg>}}, \texttt{алд{\small <n><px1sg><nom>}}
		\end{itemize}
