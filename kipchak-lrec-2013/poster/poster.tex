...
%		\end{itemize}
	...
	\headerbox{Morphological transducers}{name=morphtrans,below=kypchaklgs}{
		...
		\begin{itemize}
			...
			\item ±1 week to reach 80\% coverage, +1 week to reach 90\%
		\end{itemize}
		\includegraphics[width=0.6\textwidth,bb=50 50 554 770,angle=270]{../graphs/kumyk-yoldash-coverage}
	}
...
%		}
		...
		\headerbox{Categorisation and tagset}{name=lexc,below=morphtrans}{
...
\midrule
 ...
 \texttt{бәрі\tag{prn}\tag{qnt}\tag{px3sp}\tag{dat}} & \texttt{нәрсә\tag{prn}\tag{itg}\tag{pl}\tag{dat}} & \texttt{зат\tag{n}\tag{pl}\tag{dat}} \\
...
%  \texttt{{\small <imp>}} \> Imperative\\[-0.5ex]
  \texttt{{\small \tag{ger\_past}}} \> Verbal noun (Past)\\[-0.5ex]
...
%\vspace{1pt}\hspace{2em}
		...
		\scalebox{0.875}{
			\begin{tabular}{llrrr}
				...
				\midrule
				\multirow{4}{*}{Kazakh} & Wikipedia & 25.6M & 85.61 $\pm$ 1.37 & 0.00 \\
					& News & 3.8M & 92.12 $\pm$ 2.72  & 0.00 \\
					& Religion & 851K & 92.49 $\pm$ 1.66  & 0.00 \\\cmidrule{2-5}
				 (r50547) & Average &  & 90.07 $\pm$ 1.91  & 0.00\\
				\midrule
				\multirow{4}{*}{Tatar} & Wikipedia & 159K & 86.35 $\pm$ 2.17  & 0.00\\
					& News & 5.2M & 89.75 $\pm$ 0.07  & 0.00 \\
					& Religion & 382K & 91.25 $\pm$ 2.55 & 0.00 \\\cmidrule{2-5}
				 (r50260) & Average &  & 89.12 $\pm$ 1.60 & 0.00 \\
				\midrule
				\multirow{3}{*}{Kumyk} & News & 286K &  91.10 $\pm$ 0.86  & 0.00 \\
					& Religion & 227K & 92.47 $\pm$ 1.03  & 0.00 \\\cmidrule{2-5}
				 (r50300) & Average &  & 91.78 $\pm$ 0.94 & 0.00 \\
				\bottomrule
			\end{tabular}\\
		}
			%}
