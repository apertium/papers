...
%FIXME: gloss `scientists' correct??
In Tatar, the character ‹и› normally represents a high front vowel (e.g., ‹галимләр› `scientists'), but in Russian words it harmonises as a back vowel (e.g., ‹артистлар› `artists').

In Kazakh, ‹е› is a front diphthong (e.g., ‹елдің› `counter-\gmk{gen}'), but in Russian 
% FIXME: -ев in Kazakh
