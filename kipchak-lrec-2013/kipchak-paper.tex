...
using possessive morphology, such as Kazakh ауа райы `weather', do not take additional morphology the same way other substantives in the language do, due to the presence of a final possessive morpheme (e.g., ‹ауа райынан› `weather-\tags{abl}', not *‹ауа райыдан›). %FIXME: Explain the compound 'weather'.
