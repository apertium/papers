...
\begin{description}
 \item{\textbf{Ambiguous and `irregular' harmony}:} In Tatar, the `yoticised' vowel letters ‹е›, ‹я›, and ‹ю› each ambiguously represent a set of sounds.  For example, ‹е› can represent the sounds of /j/ followed the sound of ‹э› (as in ‹егетләр› `boys') or ‹ы› (as in ‹еллар› `years'), and is also the non-initial orthographic variant of ‹э› (as in ‹дәресләр› `lessons').  In Kumyk, ‹ё› and ‹ю› are used intervocalically to represent front rounded vowels (as in ‹гёзлер› `eyes' and ‹гюнлер› `days'), but word-initially can represent ‹й› followed by either a front (as in ‹юреклер› `hearts', ‹ёнкюлер› `darlings') or a back (as in ‹юлдузлар› `stars', ёллар `roads') vowel.  In Kazakh, the vowels /{\qipa ɘ}/ ‹і› and /ə/ ‹ы› followed by a glide /w/ ‹у› or /j/ ‹й› are written ‹у› and ‹и›, depending on the glide; for example.  The character ‹ю› is used in turn to represent ‹й› followed by either multi-phoneme value of ‹у›.  %FIXME: good Kazakh examples 
