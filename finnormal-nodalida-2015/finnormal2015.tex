...
\begin{itemize}
  \item 273 rules from \newcite{karlsson2008}'s grammar of Finnish (\S95--97)
  \item Rules from the development corpus.
\end{itemize}

%Rules: mä -> minä, oon -> olen, ?*nkaa -> ?*n kanssa
%
%Input: Mä oon Inarinkaa
%Step 1: Mä oon Inarinkaa
%        Minä oon Inarinkaa
%Step 2: Mä oon Inarinkaa
%        Minä oon Inarinkaa
%        Mä olen Inarinkaa
%        Minä olen Inarinkaa
%Step 3: Mä oon Inarinkaa
%        Minä oon Inarinkaa
%        Mä olen Inarinkaa
%        Minä olen Inarinkaa
%        Mä oon Inarin kanssa
%        Minä oon Inarin kanssa
%        Mä olen Inarin kanssa
%        Minä olen Inarin kanssa
%Rank:
%	-13.4885 ← minä olen Inarin kanssa
%	-12.7176 ← minä oon Inarin kanssa
%	-12.4408 ← mä olen Inarin kanssa
%	-9.2045 ← mä oon Inarin kanssa
%	-8.8651 ← minä olen Inarinkaa
%	-8.0941 ← minä oon Inarinkaa
%	-7.8174 ← mä olen Inarinkaa
%	-4.5811 ← mä oon Inarinkaa
%Output: Minä olen Inarin kanssa	
