...
% unsupervised does as well as CBMT, and and half the way towards pbmt

% supervised systems trained on the normalised corpus outperform those trained on the standardised corpus (WHY?)

% the rules written from the development portion of the corpus outperform the rules from the grammar
