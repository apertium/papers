...
as input into other natural language processing tasks.
\rr{R3: What is the rationale for choosing high recall at the expense of low precision?
Was it a deliberate choice or a consequence of limited development time? In my
experience, this strategy is good for corpus queries in linguistic research
(fewer relevant constructions are missed) but might be problematic for language
technology applications, which normally require full disambiguation. Since it is
stated in the introduction that the principal objective of the grammar is to
produce input to other language processing tasks, this question is especially
relevant and warrants some discussion.}
...
\c. etc. \ldots\\ \rr{is this clear that the paradigm continues, but we don't show it?}
...
%FRAN
\rr{R1 does not understand "intrinsic/extrinsic" (and neither do I) Should we rename them to be qualitative/quantitative?}
\rr{R1: Add some text introducing intrinsic evaluation. What is this section doing?}
...
so a constraint grammar can potentially resolve most stress ambiguity indirectly. The results of \newcite{reynolds.tyers-15} show that our constraint grammar overcomes about 42\% of the ambiguity relevant to stress
...
\rr{R1: Note that Johannessen et al (2012) and Lynum et al (2011) have written two articles about building a statistical tagger on top of a cg grammar.
...
Lynum, Andre; Hagen, Kristin; Johannessen, Janne Bondi; Nøklestad, Anders. OBT+Stat: Evaluation of a combined CG and statistical tagger. In NEALT Proceedings Series 2011 Vol. 14.}
...
the art employs unavailable training corpora of over five million tokens.\rr{citations? This comes out of the blue.}
...
\begin{figure}
  ...
  \label{fig:curve}
\end{figure}
\rr{R1: Figure 3 is small and hard to read. Shapes indistinguishable.}
