...
"<года>"                                                           "трибунал" n m nn sg nom
        "год" n m nn sg gen SELECT:462                             
;        "год" n m nn pl nom fac SELECT:462                   "<по>"
                                                                   "по" pr 
"<в>"                                                             
        "в" pr                                                "<Руанде>" 
...
;        "Танзания" np al f nn pl nom REMOVE:424                   "." sent 
;        "Танзания" np al f nn sg dat REMOVE:433 
;        "Танзания" np al f nn sg gen REMOVE:433

"<начал>"
        "начало" n nt nn pl gen
        "начать" vblex perf tv past m sg
;        "начать" vblex perf iv past m sg REMOVE:769
}}
\end{alltt}
  \caption{Example output from the morphological analyser and constraint grammar for the sentence \rus{В ноябре 1994 
           ...
           the output ambiguity is 1.38 readings per word. Recall is 1.0 and precision is 0.72. 
 } 
\end{figure*}
