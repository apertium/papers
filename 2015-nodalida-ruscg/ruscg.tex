...
{\small
"<\rus{В}>"                                         "<\rus{работу}>"
    "\rus{в}" pr                                        "\rus{работа}" n f nn sg acc

"<\rus{ноябре}>"                                    "<\rus{Международный}>"
    "\rus{ноябрь}" n m nn sg prp                        "\rus{международный}" adj m an sg nom
                                                 "\rus{международный}" adj m nn sg acc
"<1994>"                                        
    "1994" num                                      "<\rus{трибунал}>"
                                                        "\rus{трибунал}" n m nn sg acc
"<\rus{года}>"                                          "\rus{трибунал}" n m nn sg nom
    "\rus{год}" n m nn sg gen SELECT:r462                             
;   "\rus{год}" n m nn pl nom fac SELECT:r462       "<\rus{по}>"
                                                        "\rus{по}" pr 
"<\rus{в}>"                                                             
    "\rus{в}" pr                                    "<\rus{Руанде}>" 
                                                        "\rus{Руанда}" np al f nn sg prp 
"<\rus{Танзании}>"                                      "\rus{Руанда}" np al f nn sg dat
    "\rus{Танзания}" np al f nn pl acc                           
    "\rus{Танзания}" np al f nn sg prp              "<.>" 
;   "\rus{Танзания}" np al f nn pl nom REMOVE:r424      "." sent 
...
corpus size of 5,000 and 9,000. This seems to indicate that further improvements depend
more on the CG than on training data.
