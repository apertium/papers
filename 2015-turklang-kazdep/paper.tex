        ...
        \begin{subfigure}[b]{0.40\textwidth}
                ...
                \begin{dependency}[theme = simple, font = \small]
                   \begin{deptext}[column sep=0.2cm]
                                Айгүл \& Азаматтың \& қайда \& екенін \& білмейді. \\
                                \gmk{np} \& \gmk{np.gen} \& \gmk{adv} \& \gmk{cop} \& \gmk{neg.aor} \\
                                \gloss{Aygül} \& \gloss{Azamat} \& \gloss{where} \& \gloss{being} \& \gloss{knows not} \\
                        \end{deptext}
                        \depedge{5}{1}{\udlabel{subj}}
