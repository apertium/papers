...
\begin{figure}[htbp]
	...
	\end{dependency}
	\caption{Verbal nouns: verbal nouns are the head of everything in their own clause and can be a \udtag{ccomp} dependency of the verb they are the complement of.  Note here that the subject noun phrase is in genitive case.}\label{fig:gpr}
\end{figure}
