	...
	\begin{subfigure}[b]{0.3\textwidth}
		\begin{dependency}[theme = simple, font = \small]
		   \begin{deptext}[column sep=0.3cm]
			...
			\end{deptext}
			\depedge{1}{2}{\udlabel{compound}}
		\end{dependency}
		\caption{Compounding: a nominal depending on an attributive nominal.}\label{fig:compound}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.3\textwidth}
		\begin{dependency}[theme = simple, font = \small]
		...
		\end{dependency}
		\caption{Indefinite genitive: A nominal depending on an indefinite genitive.}\label{fig:indefgen}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.3\textwidth}
		\begin{dependency}[theme = simple, font = \small]
		   \begin{deptext}[column sep=0.3cm]
			...
			\depedge{1}{2}{\udlabel{nmod}}
		\end{dependency}
		\caption{Definite genitive: A nominal depending on an definite genitive.}\label{fig:indefgen}
	\end{subfigure}
