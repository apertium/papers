...
and Polish (xxx) and smaller languages like Irish \parencite{Lynn12}. To our knowledge, however, a treebank exists for only one other Turkic language, Turkish \parencite{Oflazer03}, which is unfortunately not freely available.
