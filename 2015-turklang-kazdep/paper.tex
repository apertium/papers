...
One example of this is indefinite genitives.  In such constructions, a ``modifying'' nominal is morphologically not marked (i.e., parsed as \tag{nom}), though it is simply an indefinite genitive.
...
\cite{ballesteros15}, \cite{nivre07}
