...
As mentioned earlier, verbal nouns combined with certain case morphology and/or postpositions can function as an adverbial adjunct to a main clause, similar to verbal adverb clauses.  In such instances, they receive the UD label \udtag{advcl}, and example of which is given in figure~\label{fig:gerabl}.
