...
Servicio Oficial de Traductores del IVAP'';\footnote{\url{http://tinyurl.com/tm-ivap}} \comment{EA: the tm-ivap link truncates "ivap" and takes me to ebay...}
...
experiment may be downloaded from our repository.\footnote{\phantom{\url{https://github.com/Sereni/Appraise/tree/1e9d735faee64d1b97fb343ab111ace6a64509d7}}}
...
\begin{enumerate}
\item As reported in \citep{oregan13}, unless the evaluation is targeted at a specific text domain, it may be beneficial to include a stylistic variety of texts in the initial corpus. Neighboring sentences on the same topic may assist the users in gap-filling tasks;
