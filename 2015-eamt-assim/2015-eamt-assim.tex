...
As suggested by \newcite{church93}, modern machine translation (MT) systems may
...
I build on the methodology established in \newcite{trosterud12} and
\newcite{oregan2013}, which are the works describing previous evaluations of
Apertium language pairs. \newcite{oregan2013} proposes the gap-filling task as a
