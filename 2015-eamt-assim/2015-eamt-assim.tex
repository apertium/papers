...
For Tatar--Russian language pair the experiment was conducted in three parts, each part on texts from different domains. The results by domains are displayed in tables \ref{table:rus-casual}, \ref{table:rus-legal}, and \ref{table:rus-news}.
