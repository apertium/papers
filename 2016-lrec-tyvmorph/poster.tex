...
\begin{document}
	...
	\headerbox{Morphological Transducers}{name=morphtrans,below=tyvan}{
		...
		\headerbox{Development cycle}{name=development,below=morphtrans,span=2}{
		\centering
		\begin{tikzpicture}[xscale=3,yscale=2.8]%, auto]
...
%			\end{tikzpicture}%}
	...
	\headerbox{Evaluation}{name=results,column=1,below=lexicon}{
