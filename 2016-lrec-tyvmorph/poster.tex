\documentclass[fontscale=0.33,landscape,paperwidth=841mm,paperheight=1189mm]{baposter}  % fontscale=0.285, dvipdfm
...
\begin{document}
	...
	\begin{poster}{
		...
		\includegraphics[height=6.4em]{uitlogo}
		\includegraphics[height=6.2em]{iu_tab-crop}
		...
		\includegraphics[height=6.2em]{img/Tuvsu}
		\includegraphics[height=6.2em]{img/soranif}
		%\hspace{2.5cm}
		\includegraphics[angle=90,height=6.7em]{apertium5b}%\hspace{-2em}
	}
	...
	\headerbox{Example: Categorisation}{name=adjectives,column=1,below=tuvanvowelharmony}{
		...
		\htwo{Implementation:\ proper categorisation}
			...
			\begin{itemize}
				...
				\item Native speaker intuitions on morph.\ limitations often more restrictive than range of possible uses found in large text corpora.
			\end{itemize}
	}
