...
\begin{document}
	...
	\headerbox{What should we put here}{name=harglebargle,column=0,below=morphtrans}{
		\vspace{0.35in}
		...
		\centering
		\begin{tikzpicture}[xscale=1.45,yscale=2.5]%, auto]
...
%			\end{tikzpicture}%}
	...
	\headerbox{Evaluation}{name=results,column=2,below=example}{ %lexicon}{
		%\begin{multicols}{2}	
	...
	%	\end{tabular}
		...
		\headerbox{Morphotactics}{name=morphotactics,column=1,below=example}{
			\begin{itemize}
		...
		\headerbox{Ongoing and future work}{name=nedostatki,column=1,below=morphotactics}{
		...
		\vspace{-1em}
		\newline
			\tikzoverlay[text width=0.9\textwidth] at (0.55in, -0.5in) {
				\includegraphics[width=0.95\textwidth]{img/dep-graph}
			};
		\begin{itemize}
			\item \textbf{Kazakh} \parencite{fmtjnw2015kazdep}
		\end{itemize}
		\includegraphics[width=0.63\textwidth]{img/korp}
		\begin{itemize}
