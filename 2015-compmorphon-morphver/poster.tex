...
\-~~~~~~~~~~~~[ :BackVow :Cns* :Cns л: ь:0 ]/:[ :0 - ь: ]* \_ ;}
	...
	\headerbox{Example: Categorisation}{name=adjectives,column=3,below=tuvanvowelharmony}{
...
%		}
		...
		\headerbox{References}{name=references,column=1,below=tuvanvelars}{
			\begin{spacing}{0.75}
		...
		\begin{itemize}
				\item Fixing morphology and disambiguation by developing a dependency treebank for Kazakh
		...
		\headerbox{Further information}{name=getting,column=2,below=adjectives,span=2}{
			%\vspace{-0.2em}
