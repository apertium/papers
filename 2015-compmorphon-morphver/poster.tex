...
\begin{document}
	...
	\begin{poster}{
		...
		{\vspace{0pt}\hspace{1cm}
			{\titlefont \textsc{Finite-state morphologies and text corpora\\as resources for improving morphological descriptions}}}
		...
		\begin{center}
			...
			\begin{minipage}[t]{9.5em}
				\begin{spacing}{0.4}
					...
					{\footnotesize Ollscoil Chathair Bhaile Átha Cliath\\\texttt{FIXME Flammie}}
				\end{spacing}
			\end{minipage}
	...
	\headerbox{Random box 1}{name=boxone,column=0,row=0}{
		\scalebox{0.78}{
			hargle
		}
	}
	
	\headerbox{Morphological transducers}{name=morphtrans,below=boxone}{
	...
	\headerbox{Categorisation}{name=adjectives,column=2}{
		\htwo{Adjectives}
			\begin{itemize}
...
ADV-ABL ;
	...
	\headerbox{Ongoing and future work}{name=nedostatki,column=3}{
		\begin{itemize}
...
%	}
		...
		\headerbox{Morphophonology}{name=morphophon,column=1}{
