...
\tikzstyle{cloud} = [draw, ellipse,fill=iumidnight, text=grey, node distance=3cm,
    minimum height=2em]
...
%		}
		...
		\headerbox{Development cycle}{name=development,below=morphtrans}{
			...
			\begin{tikzpicture}[node distance = 2cm, auto]
				...
				\node [cloud, left of=init] (addstem) at (0,3) {add stem};
				\node [cloud, right of=init] (fixphon) at (2,3) {fix phonology};
