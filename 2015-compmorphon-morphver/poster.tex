\documentclass[fontscale=0.3,landscape,paperwidth=48in,paperheight=36in]{baposter}  % fontscale=0.285, dvipdfm
...
\begin{document}
	...
	\headerbox{Morphological Descriptions}{name=morphdesc,column=0,row=0}{
		Morphological descriptions describe the \_morphotactics\_¹ and \_morphophonology\_² of a language.
		
		These are a core part of grammatical descriptions, such as reference grammars and textbooks. Due to restrictions of the medium (such as number of pages), the limitations of introspection and working with native speakers, and the lack of automatic testing, such works are often incomplete.
...
%	}
		...
		\headerbox{Example:\ Tuvan velar elision}{name=tuvanvelars,column=1,span=2}{
			\begin{multicols}{2}
				...
				\begin{itemize}
					\item /k/ ‹к› elides at the end of ≥1-{\qipa 𝛔} stems intervocalically;
					\item /g/ ‹г› elides at the end of any stem intervocalically;
					\item /ŋ/ ‹ң› elides at the end of \textit{some} stems intervocalically.
				\end{itemize}
				examples of correct forms in grammars:\\
...
\-~~~~~~~~[ .\#.\ | \%- ] [ ( :Cns* ) ( :Vow* ) :Vow ]/:0 \_ [ \%>:\ :Vow ]/:0* ; %[ :0 - \%>:\ ]* ;
				...
				\htwo{Initial frequency list}

					(FIXME: has forms of соң in it)
...
\-~~~~~~~~[ .\#.\ | \%- ] [ ( :Cns* ) ( :Vow* ) :Vow ]/:0 \_ [ \%>:\ :Vow ]/:0* ;} %[ :0 - \%>:\ ]* ;
				...
				\htwo{Resulting frequency list}

					(FIXME: has forms of бажың, түң, чаң in it)
...
%\-~~~~~~~~:Vow \_ [ \%\{☭\%\}:\ :Vow ]/:0* ;
		...
		\headerbox{Examples:\ ideas for other examples}{name=otherexamples,column=1,span=2,below=tuvanvelars}{
			\begin{itemize}
				\item Kyrgyz: conditions where л desonorises to д
				\item Tuvan: рубль - рубльдиң *рубьдуң
		...
		\headerbox{Morphophonology}{name=morphophon,column=1,below=otherexamples}{
