...
%		\end{itemize}
	...
	\headerbox{Development effort}{name=devel,below=adjectives,column=1}{
...
\end{multicols}
		...
		\headerbox{Evaluation}{name=coverage,span=1,column=3,row=0}{
...
%			\end{center}
		...
		\headerbox{Orthography-phonology mapping issues}{name=twol,column=2,below=exout}{
...
%		}
		...
		\headerbox{Ongoing and future work}{name=nedostatki,column=5}{
			\begin{itemize}
...
%					{\qipa же- \eng{eat} → жеш / *жөө \eng{eating}}
				...
				\item Bring our other Kypchak transducers to comparable performance:\\
