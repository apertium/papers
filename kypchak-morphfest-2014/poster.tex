...
\end{multicols}
		...
		\headerbox{Categorisation}{name=adjectives,below=exout,column=1}{
...
%		}
		\scalebox{0.77}{
			\begin{tabular}{llll}
				...
				\midrule
					\texttt{\textbf{Kyrgyz}} & Wikipedia & azattyk.org & Quran + Bible \\
					% 2013-05-30, 2010, 
					\texttt{\textbf{Kazakh}} & Wikipedia & azattyq.org & Quran + Bible \\
					\texttt{\textbf{Tatar}} & Wikipedia & tat.tatar-inform.ru & Quran + New Testament \\
					\texttt{\textbf{Kumyk}} & --- & yoldash.etnosmi.ru & Genesis + New Testament \\
				\bottomrule
			\end{tabular}
...
%\vspace{1pt}\hspace{2em}
		...
		\scalebox{0.89}{
			\begin{tabular}{llrrr}
				...
				\multirow{4}{*}{\textbf{Kyrgyz}} & Wikipedia & M & 84.51 $\pm$ 2.27 &  \\
					& News &  & 91.43 $\pm$ 0.51 &  \\
					& Religion &  &  $\pm$  &  \\\cmidrule{2-5}
		...
		\scalebox{0.92}{
			...
			\htwo{Acronyms and numerals}
				\begin{itemize}
					...
					\item no phonological triggers available in numerals (etc.)\\
...
%					{\qipa же- \eng{eat} → жеш / *жөө \eng{eating}}
				\item Disambiguation, more stems
				\item Clean up Kyrgyz transducer
		...
		\headerbox{Further information}{name=getting,column=0,below=morphtrans}{
			\begin{itemize}
				...
				\item Transducers available live at \href{http://turkic.apertium.org/}{\texttt{turkic.apertium.org}}
...
%				}
		...
		\headerbox{Morphotactics}{name=lexc,column=2,below=exout}{
			...
			\begin{itemize}
				...
				\texttt{ өнүк{\small <v><tv><caus><aor><p1><pl>+}бы{\small <qst>}}
				\item{} {\qipa келатсаң} \eng{if you come}\\
				\texttt{кел{\tt {\small <v><iv><prc\_impf>}}+жат{\small <vaux><gna\_cnd><p2><sg>}}
			\end{itemize}
			...
			\begin{itemize}
				\item Some combinations of possessive and case morphemes are non-canonical (i.e., not formed simply by concatenation):
