...
%		\end{itemize}
	...
	\headerbox{Development effort}{name=devel,below=morphtrans}{
		\begin{itemize}
...
\end{multicols}
		...
		\headerbox{Categorisation}{name=lexc,below=exout,column=1}{
...
%		}
		\scalebox{0.77}{
			\begin{tabular}{llll}
				...
				\midrule
					\texttt{\textbf{kaz}} & Wikipedia & azattyk.org & Quran + Bible \\
					\texttt{\textbf{tat}} & Wikipedia & tat.tatar-inform.ru & Quran + New Testament \\
					\texttt{\textbf{kum}} & --- & yoldash.etnosmi.ru & Genesis + New Testament \\
				\bottomrule
			\end{tabular}
...
%		}
		...
		\headerbox{Ongoing and future work}{name=nedostatki,column=3,below=coverage}{
			\begin{itemize}
...
%					{\qipa же- \eng{eat} → жеш / *жөө \eng{eating}}
		...
		\headerbox{Further information}{name=getting,column=4}{
			\begin{itemize}
