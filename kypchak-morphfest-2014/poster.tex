...
%%			\draw (current page.north west)+(-2em,2em) node[anchor=north west] {\includegraphics[width=0.9\textwidth]{flagkg2}};
  ...
  %headerfont=\Large\textsf, %Sans Serif
			...
			%\hspace{-2em}
			\includegraphics[angle=90,height=8em]{apertium5a}%\hspace{-2em}
...
%		\end{itemize}
	...
	\headerbox{Morphological transducers}{name=morphtrans,below=kypchaklgs}{
		...
		\begin{itemize}
			...
			\item our Kazakh, Tatar, Kumyk: all \hiliteone{GPL (=free and open)}!
		\end{itemize}
...
\end{multicols}
		...
		%\headerbox{Morphophonology}{name=morphophon,below=morphtrans}{
			\begin{itemize}
				...
				\item Our approach:\ categorisation (e.g., adjectives, below)
			\end{itemize}
			...
			\begin{tabular}{llll}
				...
				\midrule
					...
					\multirow{3}{*}{\texttt{\textbf{tat}}} & \multirow{3}{*}{{\qipa е}} & {\qipa э / C \_} & {\qipa дәр\hiliteone{е}сл\hilitetwo{ә}р} \eng{lessons} \\
						...
						&	& {\qipa /j/+э} & {\qipa ег\hiliteone{е}тл\hilitetwo{ә}р} \eng{boys} \\
				\midrule
...
%					{\qipa же- \eng{eat} → жеш / *жөө \eng{eating}}
				...
				\item Other Turkic lgs.:\ Nogay, Bashqort, Uzbek, Chuvash
			\end{itemize}
			%\vspace{0.98em}
		}
