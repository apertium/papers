...
\end{multicols}
		...
		%\headerbox{Morphophonology}{name=morphophon,below=morphtrans}{
			...
			\begin{itemize}
				...
				\item only correct forms are analysed and generated
			\end{itemize}
...
%				Recall is the probability that some correct analysis is among those provided.
				\item \textbf{Precision} - probability that a provided analysis is accurate
				\item \textbf{Recall} - probability that a certain correct analysis is among those provided by the transducer
