		...
		\scalebox{0.91}{
			\begin{tabular}{llrrr}
				...
				\multirow{4}{*}{\textbf{Kyrgyz}} & Wikipedia & 5.3M & 84.51 $\pm$ 2.27 & 3.56 \\
				 ...
				 (r54474) & Average &  & \hiliteone{89.20} $\pm$ 3.48 &  \\
				\midrule
...
%				\end{itemize}
			...
			\begin{itemize}
				\item one type of N-N compunds:\ N2 has \tag{px3} and related morphology
			\end{itemize}
			\vspace{0.6ex}
			\codeex{
			{\small
			...
			\texttt{LEXICON Nouns\\
			\vspace{-0.5ex}аба\%\ ырайы:аба\%\ ырай\ N-INFL-3PX-COMPOUND ;\\\vspace{-0.5ex}\hspace{0.1pt}\hfill{}!\ "weather"\\
			\vspace{-0.5ex}чакыруу\%\ кагазы:чакыруу\%\ кагаз\ N-INFL-3PX-COMPOUND\\\vspace{-0.5ex}\hspace{0.1pt}\hfill{};\ !\ "invitation"}}
			}
