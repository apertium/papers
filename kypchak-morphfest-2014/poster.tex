...
\end{multicols}
		...
		%\headerbox{Morphophonology}{name=morphophon,below=morphtrans}{
			...
			\begin{itemize}
				...
				\item most sources:\ adjectives can be used substantively and adverbially
		...
		\htwo{Adverbs}
			\begin{itemize}
				\item Certain time adverbs have special attributive and genetive forms\\
				бүгүн, быйыл, кече, жана, 
			\end{itemize}
...
%				}
		...
		\headerbox{Other uses}{name=uses,column=1,below=morphophon}{
			\begin{itemize}
				...
				\item Segmenter, e.g.\ {\qipa көрүшкөндөрүмдөнсүңбү} :\\
				 {\small \texttt{көр\hilitegrey{>}\{I\}ш\hilitegrey{>}\{G\}\{A\}н\hilitegrey{>}\{L\}\{A\}р\hilitegrey{>}\{I\}м\hilitegrey{>}\{D\}\{A\}н\hilitegrey{>}с\{I\}ң\hilitegrey{>}\{B\}\{I\}}}
			\end{itemize}
		}
